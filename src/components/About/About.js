...
function About(props) {
    return (
        <div className='about-wrapper container d-flex flex-column justify-content-center align-items-center mt-4 h-100'>
            <div className='logo-wrap'>
                <img src={logo} alt="logo" />
            </div>
            <h3 className='project-name text-uppercase mt-4'>Textik</h3>
